----------------------------------------------------------
-- Written by Roberto Solano https://comecaramelos.es
-- Version 2019.10.13
-- Based on Farley Farley work
-- Please submit issues, feedback, etc. at https://github.com/AndrewFarley/Taranis-XLite-Q7-Lua-Dashboard
----------------------------------------------------------
...
local function gatherInput(event)
	...
	-- Acro train mode switch
	acrotrain = getValue('sd')
